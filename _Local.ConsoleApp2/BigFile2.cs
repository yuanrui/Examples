...
{
    public class BigFile2 : IDisposable
    {
        ...
        public BigFile2(String filePath, Int64 length)
        {
            _filePath = filePath;
            _length = length;
            Init();
        ...
        public Byte[] Read(Int64 offset, out DateTime uploadDate)
        {
            ...
            MemoryMappedViewStream _stream = _memoryMappedFile.CreateViewStream(offset, Header.BLOCK_HEADER_SIZE, MemoryMappedFileAccess.ReadWrite);
            ...
            _stream = _memoryMappedFile.CreateViewStream(offset, dataLength + Header.BLOCK_HEADER_SIZE, MemoryMappedFileAccess.ReadWrite);
            index = Header.BLOCK_HEADER_SIZE;
