...
namespace _Local.ConsoleApp
{
    class Program
    {
        ...
        {
            Console.WriteLine(VersionUtils.VersionNumber);
            Console.WriteLine(VersionUtils.GetVersion());
            Console.WriteLine(VersionUtils<Program>.VersionNumber);
            Console.WriteLine(VersionUtils<Program>.GetVersion(3));
