...
namespace Simple.MvcPlugins
{
    ...
    public class PluginManager
    {
            ...
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        if (!pluginDescriptor.SupportedVersions.Contains("1.00", StringComparer.InvariantCultureIgnoreCase))
                        {
        ...
        {
            return GetPlugins().SingleOrDefault(plugin => plugin.SystemName == name);
        }
